...
import { required, useGetManyReference, useRecordContext, } from 'ra-core';
import { AdminContext, Edit, PrevNextButtons, SimpleForm, TopToolbar, } from 'ra-ui-materialui';
...
export var CustomOptions = function () { return (React.createElement(MemoryRouter, { initialEntries: ['/posts/1'] },
